...
class QNetwork(nn.Module):
    ...
    def __init__(self,input_units,output_units,seed):
        ...
        self.fc1 = nn.Linear(input_units, 5000)
        self.fc2 = nn.Linear(5000, 1000)
        self.res_block1 = ResidualBlock(1000,1000)
        self.res_block2 = ResidualBlock(1000,1000)
        self.res_block3 = ResidualBlock(1000,1000)
        self.res_block4 = ResidualBlock(1000,1000)
        #self.bn1 = nn.BatchNorm1d(5000)
        #self.bn2 = nn.BatchNorm1d(1000)
        self.fc3 = nn.Linear(1000,output_units)
        self.relu = nn.ReLU(inplace = True)
...
class QNetwork_UVFA(nn.Module):
    ...
    def __init__(self,input_units,output_units,seed):
        ...
        self.seed = torch.manual_seed(seed)
        self.fc1 = nn.Linear(2*input_units, 5000)
        self.fc2 = nn.Linear(5000, 1000)
        self.res_block1 = ResidualBlock(1000,1000)
        self.res_block2 = ResidualBlock(1000,1000)
        self.res_block3 = ResidualBlock(1000,1000)

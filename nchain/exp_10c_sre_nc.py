...
scores_dqn_2, terminal_ep_dqn_2 = dqn_sre_nc(n_episodes=100000, max_t=3*n, eps_start=1.0, eps_end=0.1, eps_decay=0.99995)

# seed = 2
agent = Learning_Agents.Agent_SREDQN(state_size=state_shape,action_size = action_shape,seed = 2)
scores_dqn_3, terminal_ep_dqn_3 = dqn_sre_nc(n_episodes=100000, max_t=3*n, eps_start=1.0, eps_end=0.1, eps_decay=0.99995)

avg_performance = (scores_dqn_1 + scores_dqn_2 + scores_dqn_3)/3
'''

np.save('/mnt/data5/vihaan/nchain/exp_10c_srenc.npy', scores_dqn_1)
...
np.save('/mnt/data5/vihaan/nchain/exp_15c_srenc.npy', scores_dqn_1)
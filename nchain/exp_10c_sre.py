...
def dqn_sre(n_episodes=1000, max_t=3*n, eps_start=1.0, eps_end=0.1, eps_decay=0.9995):
    ...
    candidate_itrs_tau = deque(maxlen=5)
    candidate_itrs_invtau = deque(maxlen=5)
...
scores_dqn_1, terminal_ep_dqn_1 = dqn_sre(n_episodes=10000, max_t=3*n, eps_start=1.0, eps_end=0.1, eps_decay=0.9995)

'''
# seed = 1
agent = Learning_Agents.Agent_SREDQN(state_size=state_shape,action_size = action_shape,seed = 1)
scores_dqn_2, terminal_ep_dqn_2 = dqn_sre(n_episodes=10000, max_t=2*n, eps_start=1.0, eps_end=0.1, eps_decay=0.9995)

# seed = 2
agent = Learning_Agents.Agent_SREDQN(state_size=state_shape,action_size = action_shape,seed = 2)
scores_dqn_3, terminal_ep_dqn_3 = dqn_sre(n_episodes=10000, max_t=2*n, eps_start=1.0, eps_end=0.1, eps_decay=0.9995)

avg_performance = (scores_dqn_1 + scores_dqn_2 + scores_dqn_3)/3
'''
np.save('/mnt/data5/vihaan/nchain/exp_10c_sre.npy', scores_dqn_1)
...
# seed = 1
agent = Learning_Agents.Agent_SREDQN(state_size=state_shape,action_size = action_shape,seed = 1)
scores_dqn_2, terminal_ep_dqn_2 = dqn_sre(n_episodes=100000, max_t=3*n, eps_start=1.0, eps_end=0.1, eps_decay=0.99995)

# seed = 2
agent = Learning_Agents.Agent_SREDQN(state_size=state_shape,action_size = action_shape,seed = 2)
scores_dqn_3, terminal_ep_dqn_3 = dqn_sre(n_episodes=100000, max_t=3*n, eps_start=1.0, eps_end=0.1, eps_decay=0.99995)

avg_performance = (scores_dqn_1 + scores_dqn_2 + scores_dqn_3)/3
'''
np.save('/mnt/data5/vihaan/nchain/exp_15c_sre.npy', scores_dqn_1)

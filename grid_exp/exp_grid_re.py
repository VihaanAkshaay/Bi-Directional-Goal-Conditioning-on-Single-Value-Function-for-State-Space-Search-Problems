...
def dqn_re(n_episodes=1000, max_t=3*n, eps_start=1.0, eps_end=0.1, eps_decay=0.9995):
    ...
    candidate_itrs_tau = deque(maxlen=10)
    candidate_itrs_invtau = deque(maxlen=10)
    ...
    for i_episode in range(1, n_episodes+1):
        ...
        for i in range(max_t):
            ...
            #Scrambler Part (Take random action)
        ...
        for i in range(max_t):
            ...
            #Scrambler Part
            action = agent.act(np.concatenate((state,itr_goal_scr)), eps)
...
scores_dqn_1, terminal_ep_dqn_1 = dqn_re(n_episodes=10000, max_t=3*n, eps_start=1.0, eps_end=0.1, eps_decay=0.9995)
'''
# seed = 1
agent = Learning_Agents.Agent_SREDQN(state_size=state_shape,action_size = action_shape,seed = 1)
scores_dqn_2, terminal_ep_dqn_2 = dqn_re(n_episodes=10000, max_t=3*n, eps_start=1.0, eps_end=0.1, eps_decay=0.9995)

# seed = 2
agent = Learning_Agents.Agent_SREDQN(state_size=state_shape,action_size = action_shape,seed = 2)
scores_dqn_3, terminal_ep_dqn_3 = dqn_re(n_episodes=10000, max_t=3*n, eps_start=1.0, eps_end=0.1, eps_decay=0.9995)

avg_performance = (scores_dqn_1 + scores_dqn_2 + scores_dqn_3)/3
'''
np.save('/mnt/data5/vihaan/grid_results/exp_grid_re_n15.npy', scores_dqn_1)
...
np.save('/mnt/data5/vihaan/grid_results/exp_grid_re_n10.npy', scores_dqn_1)
...
np.save('/mnt/data5/vihaan/grid_results/exp_grid_re_n3.npy', scores_dqn_1)
'''
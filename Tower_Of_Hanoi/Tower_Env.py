# Source - https://github.com/xadahiya/toh-gym/blob/master/toh_gym/envs/toh_env.py
...
class HanoiEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.REVERSE_ACTION_LOOKUP = {0 : "Action 2 (1,0)",
                                      1 : "Action 4 (2,0)",
                                      2 : "Action 0 (0,1)",
                                      3 : "Action 5 (2,1)",
                                      4 : "Action 1 (0,2)",
    ...
    def step(self, action):
        ...
        * Outputs:
        ...
        return np.array(self.current_state), reward, self.done, info

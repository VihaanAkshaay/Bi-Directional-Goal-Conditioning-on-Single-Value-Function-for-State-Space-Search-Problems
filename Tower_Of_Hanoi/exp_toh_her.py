...
def dqn_her(n_episodes=1000, max_t=3*pow(2,num_disks), eps_start=1.0, eps_end=0.1, eps_decay=0.9995):
...
scores_dqn_1, terminal_ep_dqn_1 = dqn_her(n_episodes=10000, max_t=10*pow(2,num_disks), eps_start=1.0, eps_end=0.1, eps_decay=0.9999)

np.save('/mnt/data5/vihaan/toh_results/exp_toh_her_disc3.npy', scores_dqn_1)
...
# seed = 0
agent = Learning_Agents.Agent_SREDQN(state_size=state_shape,action_size = action_shape,seed = 0)
scores_dqn_1, terminal_ep_dqn_1 = dqn_her(n_episodes=10000, max_t=10*pow(2,num_disks), eps_start=1.0, eps_end=0.1, eps_decay=0.9995)

np.save('/mnt/data5/vihaan/toh_results/exp_toh_her_disc4.npy', scores_dqn_1)
...
np.save('/mnt/data5/vihaan/toh_results/exp_toh_her_disc5.npy', scores_dqn_1)

...
def dqn_sre_nc(n_episodes=1000, max_t=3*pow(2,num_disks), eps_start=1.0, eps_end=0.1, eps_decay=0.9995):
...
scores_dqn_1, terminal_ep_dqn_1 = dqn_sre_nc(n_episodes=10000, max_t=10*pow(2,num_disks), eps_start=1.0, eps_end=0.1, eps_decay=0.9995)

'''
# seed = 1
agent = Learning_Agents.Agent_SREDQN(state_size=state_shape,action_size = action_shape,seed = 1)
scores_dqn_2, terminal_ep_dqn_2 = dqn_sre_nc(n_episodes=10000, max_t=3*pow(2,num_disks), eps_start=1.0, eps_end=0.1, eps_decay=0.9995)

# seed = 2
agent = Learning_Agents.Agent_SREDQN(state_size=state_shape,action_size = action_shape,seed = 2)
scores_dqn_3, terminal_ep_dqn_3 = dqn_sre_nc(n_episodes=10000, max_t=3*pow(2,num_disks), eps_start=1.0, eps_end=0.1, eps_decay=0.9995)

avg_performance = (scores_dqn_1 + scores_dqn_2 + scores_dqn_3)/3
'''

np.save('/mnt/data5/vihaan/toh_results/exp_toh_srenc_disc3.npy', scores_dqn_1)
...
avg_performance = (scores_dqn_1 + scores_dqn_2 + scores_dqn_3)/3
'''
np.save('/mnt/data5/vihaan/toh_results/exp_toh_srenc_disc4.npy', scores_dqn_1)
...
np.save('/mnt/data5/vihaan/toh_results/exp_toh_srenc_disc5.npy', scores_dqn_1)
